...
function chk_ext(f_path) {
	...
	// 根据需求定制
	var accept_ext = new Array("jpeg", "jpg", "gif","png");
	var flag = false;
	if (ext != '') {
...
function PreviewImage(fileObj,imgPreviewId,divPreviewId){
    var allowExtention="jpeg,jpg,gif,png";//document.getElementById("hfAllowPicSuffix").value;//.jpg,.bmp,.gif,.png,允许上传文件的后缀名
