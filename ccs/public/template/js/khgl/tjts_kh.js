    ...
    */
    ...
    $('#Complaint').on('click',function(){
      ...
      /*  if (!khid) {
        ...
        $.post('index.php?r=khgl/AddCustomerComplaints',{khxm:khxm,ddbh:ddbh,tsbz:tsbz,khtsgh:khtsgh,tsgjgh:tsgjgh,tscljg:tscljg,tscp:tscp,khwt:khwt},function(data){
            if(!data){
                alert('添加失败');
                return;
            }
