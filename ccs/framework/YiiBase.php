		...
		else
		{
			...
			if(strpos($className,'\\')===false)  // class without namespace
			{
				if(self::$enableIncludePath===false)
				{
				    ...
				    if (stripos($className, 'MarketplaceWebService') !== false) {
				        // 亚马逊API的自动加载问题 @YangLong
...
//		'CRedisCache' => '/caching/CRedisCache.php',	//功能有限，扩展不方便
		...
		'CInputFilter'=>'/utils/CInputFilter.php',
		'Curl'=>'/utils/Curl.php',
		'Utility'=>'/utils/Utility.php',
		'CMongodbHelper' => '/caching/CMongodbHelper.php',
		'CRedisHelper' => '/caching/CRedisHelper.php',
		'CExcelHelper' => '/caching/CExcelHelper.php',
		'CZipHelper' => '/caching/CZipHelper.php',
		'RunTimeLog'=>'/utils/RunTimeLog.php',
	);
}
